...
/// Precio del bono cero-cupón de Hull-White 2 factores (G2++, PLAN.md §7.16) observado con
...
pub fn hull_white_2f_zero_coupon_bond(a: f64, b: f64, sigma: f64, eta: f64, rho: f64, r0: f64, maturity: f64) -> f64 {
    ...
    model.zero_coupon_bond(zero.clone(), zero, 0.0, maturity).into_scalar()
}
...
pub fn irs_unilateral_cva_5y(
    ...
    // cual porque esta es la cadena de humo de Fase 0/1, no la superficie de ENGINE.PRICE.
