"""Flujo completo de price_batch/price_many/price_grid (PLAN.md §7.19) desde Python: tres niveles
de la API de cálculo por lotes, cada uno construido sobre el anterior -- ver price_flow.py
