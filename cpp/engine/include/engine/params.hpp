...
// modelo/producto/medida concreto se está construyendo. `std::string` (PLAN.md §7.15,
// añadido para `ExecutionContext`: "backend"/"precision" son texto, no numéricos) es el
// primer tipo no numérico de este bag.
using ParamValue = std::variant<double, std::vector<double>, bool, std::string>;
